// OpenALPlay.cpp : Defines the entry point for the application.
//

#include "stdafx.h"
#include "OpenALPlay.h"
                     ...
                     _In_ int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_OPENALPLAY, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_OPENALPLAY));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_OPENALPLAY));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_OPENALPLAY);
